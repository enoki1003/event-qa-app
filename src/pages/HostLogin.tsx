      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleLogin} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-rimo-300"
            autoFocus
          />
          ...
          <button
            type="submit"
            disabled={!password}
            className="mt-4 w-full py-3 bg-rimo-500 text-white font-semibold rounded-xl hover:bg-rimo-600 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
            ログイン
          </button>
        </form>
